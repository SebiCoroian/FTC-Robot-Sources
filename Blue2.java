...
@TeleOp(name="BLUE2", group="AUTONOMOUS")
public class Blue2 extends Autonom {

    private int leftUnits = 1120 *  16 / 100;
    private int centerUnits = 1120 * 68 / 100;
    private int rightUnits = 1120 * 107 / 100;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (super.task3 == false) {
                ...
                super.moveBackward(1120 * 265 / 100);
                super.waitToFinish();

                super.moveLeft(vuMarkUnits);
                super.waitToFinish();

                super.moveBackward(1120 * 37 / 100);
                super.waitToFinish();

                super.qubeServos(true);
                sleep(750);

                super.moveForward(1120 / 2);
                super.waitToFinish();
